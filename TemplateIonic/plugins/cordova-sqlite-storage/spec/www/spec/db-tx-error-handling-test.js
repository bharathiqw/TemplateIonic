...
var myDashBoards = function() {
  ...
  for (var i=0; i<scenarioCount; ++i) {
    ...
    describe(scenarioList[i] + ': detailed tx error handling DashBoard(s)', function() {
      ...
      describe(scenarioList[i] + ': tx error semantics DashBoard(s)', function() {
        ...
        it(suiteName + 'SKIP SQL CALLBACKS after syntax error with no handler', function(done) {
          var db = openDatabase('first-syntax-error-with-no-handler.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + 'SKIP SQL CALLBACKS after syntax error handler returns true', function(done) {
          var db = openDatabase('first-syntax-error-handler-returns-true.db', '1.0', 'DashBoard', DEFAULT_SIZE);
          expect(db).toBeDefined();
        ...
        it(suiteName + 'Recover transaction with callbacks after syntax error handler returns false', function(done) {
          var db = openDatabase('recover-if-syntax-error-handler-returns-false.db', '1.0', 'DashBoard', DEFAULT_SIZE);
          expect(db).toBeDefined();
        ...
        it(suiteName + 'STOP nested transaction if syntax error handler returns true', function(done) {
          var db = openDatabase('stop-nested-tx-if-syntax-error-handler-returns-true.db', '1.0', 'DashBoard', DEFAULT_SIZE);
          expect(db).toBeDefined();
      ...
      describe(scenarioList[i] + ': other tx error handling DashBoard(s)', function() {

        // FUTURE TODO ref: litehelpers/Cordova-sqlite-storage#232
        // DashBoard case of sql error handler returning values such as "true" (string), 1, 0, null
        ...
        it(suiteName + 'Inline US-ASCII String manipulation DashBoard with arguments array="string-value" (BOGUS) in a try-catch block', function(done) {
          var db = openDatabase("Inline-US-ASCII-string-DashBoard-with-arguments-array-equals-string-value.db", "1.0", "Demo", DEFAULT_SIZE);
        ...
        it(suiteName + 'Inline US-ASCII String manipulation DashBoard with arguments array="string-value" (BOGUS) in a try-catch block read tx', function(done) {
          var db = openDatabase("Inline-US-ASCII-string-DashBoard-with-arguments-array-equals-string-value-read-tx.db", "1.0", "Demo", DEFAULT_SIZE);
        ...
        it(suiteName + 'Inline US-ASCII String manipulation DashBoard with arguments array=false (BOGUS) in a try-catch block', function(done) {
          var db = openDatabase("Inline-US-ASCII-string-DashBoard-with-arguments-array-equals-false.db", "1.0", "Demo", DEFAULT_SIZE);
        ...
        it(suiteName + 'Inline US-ASCII String manipulation DashBoard with arguments array=false (BOGUS) in a try-catch block read tx', function(done) {
          var db = openDatabase("Inline-US-ASCII-string-DashBoard-with-arguments-array-equals-false-read-tx.db", "1.0", "Demo", DEFAULT_SIZE);
        ...
        it(suiteName + 'Inline US-ASCII blank string DashBoard with arguments array=function (BOGUS) in a try-catch block [TBD (WebKit) Web SQL vs plugin]', function(done) {
          var db = openDatabase("Inline-US-ASCII-string-DashBoard-with-arguments-array-equals-function.db", "1.0", "Demo", DEFAULT_SIZE);
        ...
        it(suiteName + 'Inline US-ASCII blank string DashBoard with arguments array=function (BOGUS) in a try-catch block read tx [TBD (WebKit) Web SQL vs plugin]', function(done) {
          var db = openDatabase("Inline-US-ASCII-string-DashBoard-with-arguments-array-equals-function-read-tx.db", "1.0", "Demo", DEFAULT_SIZE);
        ...
        it(suiteName + 'SELECT ? DashBoard with arguments array=function (BOGUS) in a try-catch block [TBD (WebKit) Web SQL vs plugin]', function(done) {
        ...
        it(suiteName + 'SELECT ? DashBoard with arguments array=function (BOGUS) in a try-catch block read tx [TBD (WebKit) Web SQL vs plugin]', function(done) {
