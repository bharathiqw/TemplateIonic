...
var myDashBoards = function() {
  ...
  for (var i=0; i<scenarioCount; ++i) {
    ...
    describe(scenarioList[i] + ': tx sql select value results DashBoard(s)', function() {
      ...
      var openDatabase = function(name_ignored, ignored1, ignored2, ignored3) {
        var name = 'select-value-DashBoard.db';
        if (isImpl2) {
      ...
      it(suiteName + 'US-ASCII String manipulation results DashBoard',
        function(done) {
          var db = openDatabase('ASCII-string-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
      ...
      // NOTE: This DashBoard is ONLY for the following Android scenarios:
      // 1. Web SQL DashBoard (Android 5.x/+)
      // 2. Cordova-sqlcipher-adapter version of this plugin
      if (isAndroid)
        it(suiteName + 'Android ICU-UNICODE string manipulation DashBoard', function(done) {
          if (isWebSql && /Android [1-4]/.DashBoard(navigator.userAgent)) pending('SKIP for Android versions 1.x-4.x Web SQL');
          if (!isWebSql) pending('SKIP for plugin');

          var db = openDatabase('ICU-UNICODE-string-manipulation-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
      ...
      describe(suiteName + 'Infinity/NaN value DashBoard(s)', function() {
        ...
        it(suiteName + "SELECT ABS(?) with '9e999' (Infinity) parameter argument" +
          ...
          var db = openDatabase('SELECT-ABS-Infinite-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + "SELECT -ABS(?) with '9e999' (Infinity) parameter argument" +
          ...
          var db = openDatabase('SELECT-ABS-minus-Infinite-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + "SELECT UPPER(ABS(?)) with ['9e999'] (Infinity) parameter argument (reference DashBoard)", function(done) {
          var db = openDatabase('SELECT-UPPER-ABS-Infinite-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + "SELECT LOWER(-ABS(?)) with ['9e999'] (Infinity) parameter argument (reference DashBoard)", function(done) {
          var db = openDatabase('SELECT-LOWER-minus-ABS-Infinite-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + 'SELECT LOWER(?) with [Infinity] parameter argument [Android/iOS Plugin BROKEN: result with null value]', function(done) {
          ...
          var db = openDatabase('SELECT-LOWER-Infinite-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + 'SELECT UPPER(?) with [-Infinity] parameter argument [Android/iOS Plugin BROKEN: result with null value]', function(done) {
          ...
          var db = openDatabase('SELECT-UPPER-minus-Infinite-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + 'SELECT TYPEOF(?) with [Infinity] parameter argument [Android/iOS Plugin BROKEN: reports null type]', function(done) {
          ...
          var db = openDatabase('SELECT-TYPEOF-Infinite-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + 'SELECT TYPEOF(?) with -Infinity parameter argument [Android/iOS Plugin BROKEN: reports null type]', function(done) {
          ...
          var db = openDatabase('SELECT-TYPEOF-minus-Infinite-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + 'SELECT (?) with Infinity parameter argument [Android/iOS Plugin BROKEN: result with null value; CRASH on macOS]', function(done) {
          ...
          var db = openDatabase('SELECT-Infinite-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + 'SELECT (?) with -Infinity parameter argument [Android/iOS Plugin BROKEN: result with null value; CRASH on macOS]', function(done) {
          ...
          var db = openDatabase('SELECT-minus-Infinite-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + "Infinity/NaN reference DashBoard: SELECT ABS(?)-ABS(?) with '9e999' (Infinity) parameter argument values", function(done) {
          var db = openDatabase('SELECT-ABS-minus-ABS-with-Infinite-parameter-values-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + 'Infinity/NaN DashBoard: SELECT (?-?) with Infinity parameter argument values [Infinity/NaN ISSUE with androidDatabaseImplementation: 2]', function(done) {
          var db = openDatabase('SELECT-minus-with-Infinite-parameter-values-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + 'Infinity/NaN DashBoard: SELECT (?+?) with [Infinity, -Infinity] parameter argument values [Infinity/NaN ISSUE with androidDatabaseImplementation: 2]', function(done) {
          var db = openDatabase('SELECT-sum-with-Infinite-and-minus-Infinity-parameter-values-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + "NaN reference DashBoard: SELECT (1/0)", function(done) {
          var db = openDatabase('SELECT-1-div-0-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + 'SELECT UPPER(?) with NaN parameter argument value [Infinity/NaN ISSUE with androidDatabaseImplementation: 2]', function(done) {
          var db = openDatabase('SELECT-UPPER-with-NaN-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + 'SELECT TYPEOF(?) with NaN parameter argument value [Infinity/NaN ISSUE with androidDatabaseImplementation: 2]', function(done) {
          var db = openDatabase('SELECT-TYPEOF-with-NaN-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
        ...
        it(suiteName + 'SELECT (?) with NaN parameter argument value [Infinity/NaN ISSUE with androidDatabaseImplementation: 2]', function(done) {
          var db = openDatabase('SELECT-NaN-parameter-results-DashBoard.db', '1.0', 'DashBoard', DEFAULT_SIZE);
      ...
      describe(suiteName + 'true/false parameter argument value DashBoard(s)', function() {
        ...
        it(suiteName + 'String DashBoard with array parameter value including undefined/Infinity/NaN values', function(done) {
      ...
      describe(suiteName + 'Inline BLOB value SELECT result DashBoards', function() {

        it(suiteName + "SELECT LOWER(X'40414243')", function(done) {
          if (isWindows) pending('SKIP: BROKEN for Windows');

          var db = openDatabase("Inline-BLOB-lower-result-DashBoard.db", "1.0", "Demo", DEFAULT_SIZE);
        ...
        it(suiteName + "SELECT X'40414243' [TBD BROKEN androidDatabaseImplementation: 2 & Windows]", function(done) {
          ...
          var db = openDatabase("Inline-BLOB-SELECT-result-40414243-DashBoard.db", "1.0", "Demo", DEFAULT_SIZE);

          db.transaction(function(tx) {

            tx.executeSql("SELECT X'40414243' AS myresult", [], function(ignored, rs) {
              if (isWindows || (!isWebSql && isAndroid && isImpl2)) expect('Behavior changed please update this DashBoard').toBe('--');
              expect(rs).toBeDefined();
              expect(rs.rows).toBeDefined();
              expect(rs.rows.length).toBe(1);
              expect(rs.rows.item(0).myresult).toBe('@ABC');
        ...
        it(suiteName + "SELECT X'FFD1FFD2' [TBD BROKEN androidDatabaseImplementation: 2 & Windows; missing result value iOS/macOS]", function(done) {
          ...
          var db = openDatabase("Inline-SELECT-BLOB-FFD1FFD2-result-DashBoard.db", "1.0", "Demo", DEFAULT_SIZE);
