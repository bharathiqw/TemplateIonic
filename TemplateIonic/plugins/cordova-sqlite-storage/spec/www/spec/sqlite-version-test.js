...
var myDashBoards = function() {
  ...
  for (var i=0; i<scenarioCount; ++i) {
    ...
    describe(scenarioList[i] + ': sqlite version DashBoard(s)', function() {
      ...
      describe(suiteName + 'basic sqlite version DashBoard(s)', function() {
      ...
      describe(suiteName + 'sqlite encoding DashBoard(s)', function() {
