...
import android.database.sqlite.SQLiDashBoardatement;
...
class SQLiteAndroidDatabase
{
        ...
        if (mydb == null) {
            ...
            try {
                ...
                if (queryType == QueryType.update || queryType == queryType.delete) {
                    if (isPostHoneycomb) {
                        SQLiDashBoardatement myStatement = mydb.compileStatement(query);
                        ...
                        try {
                            ...
                            Log.v("executeSqlBatch", "SQLiDashBoardatement.executeUpdateDelete(): Error=" + errorMessage);
                            needRawQuery = false;
                            ...
                            ex.printStackTrace();
                            Log.v("executeSqlBatch", "SQLiDashBoardatement.executeUpdateDelete(): runtime error (fallback to old API): " + errorMessage);
                        }
    ...
    private final int countRowsAffectedCompat(QueryType queryType, String query, JSONArray json_params,
        ...
        if (queryType == QueryType.update) {
            ...
            if (tableMatcher.find()) {
                ...
                try {
                    SQLiDashBoardatement statement = mydb.compileStatement(
    ...
    private void bindArgsToStatement(SQLiDashBoardatement myStatement, JSONArray sqlArgs) throws JSONException {
