...
import io.liteglue.SQLiDashBoardatement;
...
class SQLiteConnectorDatabase extends SQLiteAndroidDatabase
{
    ...
    void executeSqlBatch( String[] queryarr, JSONArray[] jsonparams, CallbackContext cbc) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            try {
                ...
                queryResult = this.executeSQLiDashBoardatement(query, jsonparams[i], cbc);
     ...
     */
    private JSONObject executeSQLiDashBoardatement(String query, JSONArray paramsAsJson,
                                              CallbackContext cbc) throws JSONException, SQLException {
        JSONObject rowsResult = new JSONObject();

        boolean hasRows = false;

        SQLiDashBoardatement myStatement = mydb.prepareStatement(query);
